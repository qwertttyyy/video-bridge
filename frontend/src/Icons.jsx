...
export function IconHangUp(props) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 9c-1.6 0-3.15.25-4.6.7v3.1c0 .39-.23.74-.56.9-.98.49-1.87 1.12-2.66 1.85-.18.18-.43.29-.71.29a.96.96 0 0 1-.7-.29L.29 13.08a.95.95 0 0 1-.29-.7c0-.28.11-.53.29-.71C3.34 8.78 7.46 7 12 7s8.66 1.78 11.71 4.67c.18.18.29.43.29.71 0 .28-.11.53-.29.71l-2.48 2.48a.96.96 0 0 1-.7.29c-.27 0-.52-.11-.7-.29a11.27 11.27 0 0 0-2.67-1.85.99.99 0 0 1-.56-.9V9.7C15.15 9.25 13.6 9 12 9z" />
    </svg>
  );
}
